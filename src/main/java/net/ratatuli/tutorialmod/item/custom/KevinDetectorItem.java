package net.ratatuli.tutorialmod.item.custom;
...
public class KevinDetectorItem extends Item {
    public KevinDetectorItem(Properties pProperties){
        super(pProperties);
    }
            ...
            for(int i = 0; i <= positionClicked.getY() + 64; i++){
                ...
                if(isValuableBlock(state)){
                    ...
                    pContext.getLevel().playSeededSound(null, positionClicked.getX(), positionClicked.getY(), positionClicked.getZ(),
                            ModSounds.KEVIN_DETECTOR_FOUND_ORE.get(), SoundSource.BLOCKS, 1f, 1f, 0);
